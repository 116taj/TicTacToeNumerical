...
public class Gameend extends AppCompatActivity {
    ...
    public void flip(ImageView i) {
        ...
        if (turn == 1) {
            ...
            turn = 2;
            p2select = -1;
            turnpic.setImageResource(R.drawable.oturne);
            win();
            if (aienable && gameover == false) {
                aiturn(a, b, c, d, e, f, g, h, p);
                turnpic.setImageResource(R.drawable.xturne);
            }
        } else {
            changeeven(i);
    ...
    public void changeodd(ImageView e) {
        switch (p1select) {
            case 1:
                e.setImageResource(R.drawable.xpice);
                break;
            case 3:
                e.setImageResource(R.drawable.xpic3e);
                break;
            case 5:
                e.setImageResource(R.drawable.xpic5e);
                break;
            case 7:
                e.setImageResource(R.drawable.xpic7e);
                break;
            case 9:
                e.setImageResource(R.drawable.xpic9e);
                break;
        }
    }
    ...
    public void changeeven(ImageView e) {
        switch (p2select) {
            case 2:
                e.setImageResource(R.drawable.opice);
                break;
            case 4:
                e.setImageResource(R.drawable.opic4e);
                break;
            case 6:
                e.setImageResource(R.drawable.opic6e);
                break;
            case 8:
                e.setImageResource(R.drawable.opic8e);
                break;
        }
    }
    ...
    public void win() {
        ...
        if (board[0][0] + board[0][1] + board[0][2] == 15 && board[0][0] != 0 && board[0][1] != 0 && board[0][2] != 0)
            ...
            winner = 3;
        if (winner == 2) {
            Toast.makeText(getApplicationContext(), "Obsidian Wins", Toast.LENGTH_SHORT).show();
            gameover = true;
            p1numwins++;
            try {
            ...
            Toast.makeText(getApplicationContext(), "Endstone Wins", Toast.LENGTH_SHORT).show();
            gameover = true;
            p2numwins++;
        } else if (winner == 3) {
    ...
    public void reset(View view) {
        ...
        ImageView num = (ImageView) findViewById(R.id.number);
        num.setImageResource(R.drawable.xpice);
        ImageView turnpic = (ImageView) findViewById(R.id.turn);
        turnpic.setImageResource(R.drawable.xturne);
        ...
        p1isreplacing = false;
        p2isreplacing = false;
        xreplace.setImageResource(R.drawable.notreplacingxe);
        oreplace.setImageResource(R.drawable.notreplacingoe);
    }
    ...
    public void replacetogglex(View view) {
        if (turn == 1) {
            if (!p1hasreplaced) {
                ImageView xreplace = (ImageView) findViewById(R.id.replacex);
                if (!p1isreplacing) {
                    xreplace.setImageResource(R.drawable.xturne);
                    p1isreplacing = true;
                } else {
                    xreplace.setImageResource(R.drawable.notreplacingxe);
                    p1isreplacing = false;
    ...
    public void replacetoggleo(View view) {
        if (turn == 2) {
            if (!p2hasreplaced) {
                ImageView oreplace = (ImageView) findViewById(R.id.replaceo);
                if (!p2isreplacing) {
                    oreplace.setImageResource(R.drawable.oturne);
                    p2isreplacing = true;
                } else {
                    oreplace.setImageResource(R.drawable.notreplacingoe);
                    p2isreplacing = false;
    ...
    public void replace(ImageView pic, int i, int j) {
        ...
        if (turn == 1) {
            ...
            p1isreplacing = false;
            ImageView xreplace = (ImageView) findViewById(R.id.replacex);
            xreplace.setImageResource(R.drawable.usedxe);
        } else {
            switch (restore) {
                case 1:
                    oddavail[0] = 1;
            ...
            p2isreplacing = false;
            ImageView oreplace = (ImageView) findViewById(R.id.replaceo);
            oreplace.setImageResource(R.drawable.usedoe);
        }
